<div class="container" style="min-width: 600px;">
	<form id="{$class_name}_{$db_name}_edit_form_[CURLY_OPEN]$data.id}">
		...
		<div style="display: inline-block; width:100%;margin-bottom: 15px;padding-right: 15px;">
			<button id="add_tast_step" class="ajax-link lang" data-form="{$class_name}_{$db_name}_edit_form_[CURLY_OPEN]$data.id}" data-class="[CURLY_OPEN]$class}" data-function="edit_exe" style="margin-right:15px;">Update</button>
		</div>
