<div class="container" style="min-width: 600px;">
	<form id="{$class_name}_{$db_name}_add_form">
		...
		<div class="">
			...
			<div style="display:flex;">
				<div style="width:100%;">
					...
					<input class="datepicker" type="text" name="scheduled_date" id="add_task_step_name"
						   value="[CURLY_OPEN]$post['scheduled_date']}" style="width:100%;">
					<p class="error" id="add_task_step_name_err">[CURLY_OPEN]$errors['scheduled_date']}</p>
				</div>

				<div style="width:100%; margin-left:10px;">
					<p class="lang label">Start Time</p>
					<input class="timepicker" type="text" name="start_time" id="add_task_step_name"
						   value="[CURLY_OPEN]$post['start_time']}" style="width:100%;">
					<p class="error" id="add_task_step_name_err">[CURLY_OPEN]$errors['start_time']}</p>
				</div>

				<div style="width:100%; margin-left:10px;">
					<p class="lang label">End Time</p>
					<input type="text" name="end_time" value="[CURLY_OPEN]$post['end_time']}" style="width:100%;"
						   class="timepicker">
		...
		<div style="display: inline-block; width:100%;margin-bottom: 15px;padding-right: 15px;">
			<button id="add_tast_step" class="ajax-link lang" data-form="{$class_name}_{$db_name}_add_form"
					data-class="[CURLY_OPEN]$class}" data-function="add_task_step_exe"
