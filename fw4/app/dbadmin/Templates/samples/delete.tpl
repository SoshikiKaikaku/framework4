<form id="{$class_name}_{$db_name}_delete_form_[CURLY_OPEN]$data.id}">
	...
	<span class="lang">Delete the following {$db_name_str}</span>
...
<button class="ajax-link lang" data-form="{$class_name}_{$db_name}_delete_form_[CURLY_OPEN]$data.id}" data-class="[CURLY_OPEN]$class}" data-function="delete_exe">Delete</button>
